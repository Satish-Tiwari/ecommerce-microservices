package com.ecommerce.product_service.api;
 ...
 public class ProductController {
     ...
     public ResponseEntity<ProductDto> createProduct(
             @Valid @RequestPart("dto") ProductDto productDto,
             @RequestPart(value = "files", required = false) MultipartFile[] files) {
         log.info("POST /api/products :: Creating product [{}] with images", productDto.getName());
     ...
     public List<ProductDto> filterProducts(
         ...
         return productService.filterProducts(categoryId, brand, productType, status, minPrice, maxPrice, stockStatus, page, size);
     }
