...
public class CommonConfiguration {
    ...
    KafkaSender<String, String> kafkaSender() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, reactiveKafkaAppProperties.getBootstrapServers());
    ...
    ReceiverOptions<String, String> receiverOptions() {
        ...
        propsReceiver.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, reactiveKafkaAppProperties.getBootstrapServers());
        propsReceiver.put(ConsumerConfig.GROUP_ID_CONFIG, reactiveKafkaAppProperties.getConsumerGroupId());
