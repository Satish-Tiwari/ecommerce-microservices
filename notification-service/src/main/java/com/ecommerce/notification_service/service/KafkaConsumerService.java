...
public class KafkaConsumerService {
    ...
    @KafkaListener(topics = { KafkaConstant.PROFILE_ONBOARDING_TOPIC, KafkaConstant.USER_LOGIN_TOPIC,
            KafkaConstant.USER_LOGOUT_TOPIC }, groupId = "notification-group")
    ...
    private void sendLoginEmail(UserEvent event) {
        String htmlContent = "<html><body style='font-family: Arial, sans-serif;'>" +
                ...
                "</div>" +
                "<p style='font-size: 16px;'>Hi <strong>" + event.getFirstName() + "</strong>,</p>" +
                "<p>You have been successfully logged in. If this wasn't you, please secure your account immediately.</p>"
                +
        ...
        emailService.sendHtmlMail(details).subscribe(res -> log.info("Login email status: {}", res));
    }
